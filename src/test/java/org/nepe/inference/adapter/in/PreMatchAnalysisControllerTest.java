...
class PreMatchAnalysisControllerTest {
    ...
    void shouldEnforceConstructorInvariants() {
        assertThatThrownBy(() -> new PreMatchAnalysisController(
                null, manageMatchUseCase, manageMarketOddsUseCase, manageSettingsUseCase, springFXMLLoader))
                .isInstanceOf(NullPointerException.class)
                .hasMessageContaining("CalculatePreMatchInferenceUseCase must not be null");

        assertThatThrownBy(() -> new PreMatchAnalysisController(
                calculatePreMatchInferenceUseCase, null, manageMarketOddsUseCase, manageSettingsUseCase, springFXMLLoader))
                .isInstanceOf(NullPointerException.class)
                .hasMessageContaining("ManageMatchUseCase must not be null");

        assertThatThrownBy(() -> new PreMatchAnalysisController(
                calculatePreMatchInferenceUseCase, manageMatchUseCase, null, manageSettingsUseCase, springFXMLLoader))
                .isInstanceOf(NullPointerException.class)
                .hasMessageContaining("ManageMarketOddsUseCase must not be null");

        assertThatThrownBy(() -> new PreMatchAnalysisController(
                calculatePreMatchInferenceUseCase, manageMatchUseCase, manageMarketOddsUseCase, null, springFXMLLoader))
                .isInstanceOf(NullPointerException.class)
                .hasMessageContaining("ManageSettingsUseCase must not be null");

        assertThatThrownBy(() -> new PreMatchAnalysisController(
                calculatePreMatchInferenceUseCase, manageMatchUseCase, manageMarketOddsUseCase, manageSettingsUseCase, null))
                .isInstanceOf(NullPointerException.class)
